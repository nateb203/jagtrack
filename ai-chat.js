  ...
  try {
    ...
    const stream = hf.chatCompletionStream({
      ...
      messages: [
        { 
          role: "system", 
          content: "You are a helpful homework assistant for high school students. Provide clear, educational explanations that help students learn. Keep responses concise and encouraging. You mainly focus on College Algebra. Please ensure you do not make up answers if you are unsure about a topic. Also provide clear and quick assistance aswell with other outside resources."
        },
